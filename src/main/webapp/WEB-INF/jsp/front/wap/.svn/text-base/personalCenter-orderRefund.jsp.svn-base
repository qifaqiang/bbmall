		...
		<div class="w-orderStatusNav w-show">
			...
			<div class="w-orderList">
				<div class="w-orderList-title-details">
					...
					<!--<p>支付来源：{{=uslog.pay_form}}</p>-->
                    
                    <p>支付方式：{{ if(uslog.pay_type==1) {}} 支付宝支付
			        {{}}}
                     {{ if(uslog.pay_type==2) {}}微信支付
			        {{}}}
                     {{ if(uslog.pay_type==3) {}}银联支付
			        {{}}}
            ...
            <div class="w-orderList-operation">
		        <div class="w-orderList-operation-button">
                  ...
                  <button class="w-btnOk" onclick="javascript:window.location.href='personalCenter-refundApplication-w.html?id={{=uslog.id}}'"> 退&nbsp;&nbsp;款</button> 
		        </div>
            {{}}}
            {{ if(uslog.status=="50") {}}
            <div class="w-orderList-operation">
