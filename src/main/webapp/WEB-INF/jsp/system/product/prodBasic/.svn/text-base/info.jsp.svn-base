...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			商品字典设置 <small>分类</small>
		</h3>
		<ul class="page-breadcrumb breadcrumb">
			<li><i class="fa fa-home"></i> <a href="javascript:void(0)">
					商品管理 </a> <i class="fa fa-angle-right"></i></li>
			<li><a href="javascript:void(0)"> 字典信息 </a></li>
		</ul>
			...
			<div class="portlet-body form">
				...
				<form class="form-horizontal" id="form_config" method="post"
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-3">单位 ： <span class="required"> * </span> </label>
							<div class="col-md-4">
								<input type="text" class="form-control w_require "
									value="${obj.unit }" name="unit" 
							</div>
						</div>
					</div>
