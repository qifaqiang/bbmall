...
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<form action="companyList.html" method="post" id="list">
	<div class="row">
				...
				<div class="portlet-body">
					...
					<div class="input-group"
						...
						<button class="btn btn-primary"
							...
							type="button">添加系统用户</button>
						<input type="text" class="form-control w_mobile "
							value="${ company.login}" style="width: 180px; float: right;"
							name="login" placeholder="" id="login"> <span
										...
										<c:forEach items="${objList}" var="product" varStatus="vs">
											...
											<tr class="">
												...
												<td style="width: 25%"><a style="margin-top:5px;"
													onclick="editCompany(${product.companyId})"
													href="javascript:void(0)" class="btn default btn-xs purple">
