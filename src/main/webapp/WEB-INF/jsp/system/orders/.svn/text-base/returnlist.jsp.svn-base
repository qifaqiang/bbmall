	...
	<div class="col-md-6" style="width: 100%">
		...
		<form action="returnorderslist.html?typeid=${param.typeid }" method="post">
			...
			<div class="portlet box blue">
				...
				<div class="col-md-4" style="width:720px;">
						<div class="controls">
							<select
								...
								class="span4">
							<div class="input-prepend input-group" style="margin-left:350px;">
...
<script>
					...
					buttons : {
						main : {
							...
							callback : function() {
								$
										.ajax({
											url : '${SHOPDOMAIN}/system/orders/tuihuo.html',
											type : 'post',
											dataType : 'json',
											data : {
												orderid : id,
	...
	function gotos(ty) {
		window.location.href = "returnorderslist.html?typeid=${param.typeid}&ty="
				+ ty+ "&companyId=" + $("#companyId").val()+"&ordersn="+$("#ordersn").val();
	}
