...
function _escape(val) {
	return val.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/&amp;cid/g,'&cid');
}
...
K.options = {
	...
	zIndex : 811213,
	items : [
		 'source','|','undo', 'redo', '|', 'preview', 'print', 'template', 'cut', 'copy', 
		'plainpaste',  '|', 'selectall', '|', 'fullscreen',
		 '|', 'removeformat', '|',  'emoticons','link', 'unlink'
	],
