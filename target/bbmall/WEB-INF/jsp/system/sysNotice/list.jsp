...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			系统设置 <small>系统公告管理</small>
		</h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				<li><i class="fa fa-home"></i> <span>系统管理</span> <i
					class="fa fa-angle-right"></i></li>
				<li><span>系统公告管理</span> <c:if test="${not empty param.pid }">
...
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<form action="list.html?date=<%=System.currentTimeMillis()%>" method="post" id="list">
	<div class="row">
				...
				<div class="portlet-body">
					<div class="input-group"
						...
						<button class="btn btn-primary"
							...
							type="button">添加系统公告</button>
						<input type="text" class="form-control "
							style="width: 100px; float: right; margin-right: 10px"
							name="title" placeholder="" id="name" value="${objs.title}">
							
							<span style="float:right;line-height:35px;height:35px;">标题:&nbsp;</span>
